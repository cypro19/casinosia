...
const PanelTopWinnings = () => {
  const translate = useTranslate();
  return (
    <Panel
      header={
        <Header>{translate("page.dashboard.panels.top-winnings.title")}</Header>
      }
      link={
        <StyledButton variant="text" endIcon={<ArrowForwardRoundedIcon />}>
          {translate("page.dashboard.panels.top-winnings.button")}
        </StyledButton>
      }
    >
      <StyledList>
...
export default PanelTopWinnings;
