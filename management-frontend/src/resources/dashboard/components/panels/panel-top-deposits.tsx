...
const PanelTopDeposits = () => {
  const translate = useTranslate();
  return (
    <Panel
      header={
        <Header>
          {translate("page.dashboard.panels.top-depositors.title")}
        </Header>
      }
      link={
        <StyledButton variant="text" endIcon={<ArrowForwardRoundedIcon />}>
          {translate("page.dashboard.panels.top-depositors.button")}
        </StyledButton>
      }
    >
      <StyledList>
...
export default PanelTopDeposits;
