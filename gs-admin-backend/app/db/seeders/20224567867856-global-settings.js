  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert("global_settings", [
      ...
      },
      {
        key: "SENDGRID_EMAIL",
        value:
          "U2FsdGVkX1+8ezqDjhtQGFdrHGyj3RHhUlRsAblENWv7fdXzOTe1AolUDyYP5aW2",
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        value:
          "U2FsdGVkX1/UkyucIqLdF4TcYSzyRfigYBaXWbzG3AE7+4nRFQxwezyi92Oz9mekwegaBqRmxSeTHePBU8loxf+DkUTh9xZZQbMQ17visOfeSk1YBapxYOZFQIVD00xD",
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
      ...
      },
      {
        ...
        value: JSON.stringify({
          casinoBackground:
            "https://gammastack-casino.s3.amazonaws.com/development/admin_banner_image_a7k3bl4fzfi-1675335621474.png",
          casinoBanner:
            "https://gammastack-casino.s3.amazonaws.com/development/admin_banner_image_a7k3bl4fzfi-1675335621474.png",
          homeBackground:
            "https://gammastack-casino.s3.amazonaws.com/development/admin_banner_image_a7k3bl4fzfi-1675335621474.png",
