...
import { getBonusStart, getTABonusStart } from "../../store/redux-slices/bonus";
      ...
      case "DEPOSIT":
        setKeys([
          { label: "Days To Clear", value: bonusDetail?.daysToClear },
          {
            ...
            value: bonusDetail?.wageringMultiplier,
          },
          {
            label: "Bonus Percentage",
            value: bonusDetail?.depositBonusPercent + "%",
          },
          {
            label: "Min Deposit",
            value: bonusDetail?.currency?.[currencyCode]?.minDeposit,
          },
        ]);
        break;
