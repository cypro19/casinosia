...
const ManageMoney = ({ show, handleClose, user }) => {
  const { deposit } = useManageMoney();
              ...
              <Modal.Body>
                    ...
                    <tr>
                      ...
                      <td>
                        <FormCheck.Input
                          ...
                          onBlur={handleBlur}
                        />
                        <FormCheck.Label htmlFor="add-money">
                          Add Money
                        </FormCheck.Label>
                      </td>
                      <td>
                        <FormCheck.Input
                          ...
                          onBlur={handleBlur}
                        />
                        <FormCheck.Label htmlFor="remove-money">
                          Remove Money
                        </FormCheck.Label>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <FormCheck.Input
                          ...
                          onBlur={handleBlur}
                        />
                        <FormCheck.Label htmlFor="non-cash">
                          Bonus
                        </FormCheck.Label>
                      </td>
                    </tr>
                ...
                <div className="form-group">
                  <label
                    htmlFor="addAmount"
                    className={
                      touched.addAmount && errors.addAmount ? "text-danger" : ""
                    }
                  >
                    Amount
                  </label>
                  ...
                  <InputGroup
                    className={
                      touched.addAmount && errors.addAmount
                        ? "border border-danger"
                        : ""
                    }
                  >
                    <InputGroup.Text>{user?.currencyCode}</InputGroup.Text>
